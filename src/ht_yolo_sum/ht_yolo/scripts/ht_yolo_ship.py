...
def detect(save_img=False):
    ...
    rospy.init_node('ht_publish_node_right', anonymous=True)
    image_pub = rospy.Publisher('/ht_image_view/ht_image_right', Image, queue_size=1)  #检测结果可视化发布
    info_pub = rospy.Publisher('/ht_detect_result_right', Ht_detection_list, queue_size=1) # 自定义信息类型发布

    weights = '/home/nvidia/ht_yolo_sum_ws/src/ht_yolo_sum/ht_yolo/weights/yolov5l.pt'
    view_img=False
    imgsz=640
    conf_thres=0.4
    iou_thres=0.5
