...
def detect(save_img=False):
    ...
    rospy.init_node('ht_publish_node', anonymous=True)
    image_pub = rospy.Publisher('/ht_image_view/ht_image_raw', Image, queue_size=1)  #检测结果可视化发布
    info_pub = rospy.Publisher('/ht_num_info', Ht, queue_size=10) # 自定义信息类型发布

    out='inference/output'
    # weights='weights/best.pt'
    weights = '/home/ht/ht_code/2d_object_detection/ht_ros_yolov5-1.0/src/ht_yolo/weights/yolov5s.pt'
    view_img=False
    save_txt=False
    imgsz=1280
    save_txt=True
